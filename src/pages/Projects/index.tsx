import { creatApikey, delApikey, getApikeyList, updateApikey } from '@/services/projects';
...
const Projects: React.FC = () => {
  ...
  const onSubmit = async (record?: Projects.ProjectsEntity) => {
  ...
  const showModal = (record?: Projects.ProjectsEntity) => {
    Modal.confirm({
      title: record ? '编辑' : '添加',
